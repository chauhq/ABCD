...
public class VipPostFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(new ProfilePostAdapter(posts, getActivity(), new OnPostListener() {
            ...
            public void deletePost(final Post post) {
                database.getReference("suggestion").child(String.valueOf(post.getId())).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
    ...
    public void getData() {
        database.getReference("suggestion").orderByChild("userId").equalTo(user.getMyPhone()).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
